...
* Khi trời NÓNG, 20% bạn dùng 1 viên đá, 40% bạn dùng 2 viên, 40% cho 3 viên. Khi trời LẠNH, 50% bạn dùng 1 viên, 40% bạn dùng 2, 10% bạn dùng 3. Đây là các khả năng trong quá trình quan sát (observation likelihood)
* Khi trời NÓNG, 30% nó sẽ chuyển sang LẠNH, 70% giữ nguyên. Khi trời LẠNH, 40% nó sẽ chuyển sang NÓNG, 60% giữ nguyên. Đây là khả năng dịch chuyển (trainsition likelihood)
