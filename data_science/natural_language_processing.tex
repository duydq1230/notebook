...
\info{24/11/2017: Nhánh của Trí tuệ nhân tạo mà hiện tại mình đang theo đuổi. Project hiện tại là \href{https://github.com/magizbox/underthesea}{underthesea}. Với mục đích là xây dựng một toolkit cho xử lý ngôn ngữ tự nhiên tiếng Việt.
}
